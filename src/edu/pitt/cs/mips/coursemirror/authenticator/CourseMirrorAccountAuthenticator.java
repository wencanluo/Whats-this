...
import static edu.pitt.cs.mips.coursemirror.authenticator.CourseMirrorAuthenticatorActivity.PARAM_AUTHTOKEN_TYPE;

class CourseMirrorAccountAuthenticator extends AbstractAccountAuthenticator {

    private static final String DESCRIPTION_CLIENT = "CourseMIRROR for Android";

    private final Context context;

    public CourseMirrorAccountAuthenticator(final Context context) {
        super(context);
    ...
    public Bundle addAccount(final AccountAuthenticatorResponse response, final String accountType,
        ...
        final Intent intent = new Intent(context, CourseMirrorAuthenticatorActivity.class);
     ...
     * {@link edu.pitt.cs.mips.coursemirror.authenticator.ApiKeyProvider#getAuthKey()}
    ...
    public Bundle getAuthToken(final AccountAuthenticatorResponse response,
        ...
        bundle.putString(KEY_ACCOUNT_TYPE, Constants.Auth.COURSEMIRROR_ACCOUNT_TYPE);
