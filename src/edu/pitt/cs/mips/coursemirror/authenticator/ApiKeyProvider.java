...
import static edu.pitt.cs.mips.coursemirror.util.Constants.Auth.AUTHTOKEN_TYPE;
import static edu.pitt.cs.mips.coursemirror.util.Constants.Auth.COURSEMIRROR_ACCOUNT_TYPE;
...
public class ApiKeyProvider {
     ...
     * {@link edu.pitt.cs.mips.coursemirror.authenticator.CourseMirrorAccountAuthenticator} will get started.
     ...
     * {@link edu.pitt.cs.mips.coursemirror.core.CourseMirrorService} instance
    ...
    public String getAuthKey(final Activity activity) throws AccountsException, IOException {
        final AccountManagerFuture<Bundle> accountManagerFuture
                = accountManager.getAuthTokenByFeatures(COURSEMIRROR_ACCOUNT_TYPE,
