 ...
 */
public class CourseMirrorAuthenticatorActivity extends ActionBarAccountAuthenticatorActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        courseMirrorService = CourseMirrorModule.getCourseMirrorService();
        bus = CourseMirrorModule.getOttoBus();
    ...
    public void onUnAuthorizedErrorEvent(UnAuthorizedErrorEvent unAuthorizedErrorEvent) {
        ...
        Toaster.showLong(CourseMirrorAuthenticatorActivity.this, R.string.message_bad_credentials);
    }
    ...
    public void handleLogin(final View view) {
        ...
        authenticationTask = new SafeAsyncTask<Boolean>() {
            public Boolean call() throws Exception {
                ...
                User loginResponse = courseMirrorService.authenticate(email, password);
            ...
            protected void onException(final Exception e) throws RuntimeException {
                ...
                if(!(e instanceof RetrofitError)) {
                    ...
                    if(cause != null) {
                        Toaster.showLong(CourseMirrorAuthenticatorActivity.this, cause.getMessage());
                    }
                }
            }
    ...
    protected void finishConfirmCredentials(final boolean result) {
        final Account account = new Account(email, Constants.Auth.COURSEMIRROR_ACCOUNT_TYPE);
    ...
    protected void finishLogin() {
        ...
        intent.putExtra(KEY_ACCOUNT_TYPE, Constants.Auth.COURSEMIRROR_ACCOUNT_TYPE);
    ...
    public void onAuthenticationResult(final boolean result) {
        if (result) {
            ...
            if (requestNewAccount) {
                Toaster.showLong(CourseMirrorAuthenticatorActivity.this,
    ...
    /**
     * handles onClick event on the "new user? sign up" button
     * open the form for the user to fill in
     * Specified by android:onClick="handleSignup" in the layout xml
     * 
     */
    public void handleSignup(final View view){
    	Intent intent_signup = new Intent(this, CourseMirrorSignupActivity.class);
